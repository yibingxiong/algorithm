...
public class MergeSort {
    ...
    public static void mergeSort7(int[] arr, int i, int j) {
        if (i < j) {
            int mid = i + (j - i) / 2;
            mergeSort7(arr, i, mid);
            mergeSort7(arr, mid + 1, j);
            merge7(arr, i, j, mid);
        }
    }
    ...
    public static void mergeSort9(int[] arr, int i, int j) {
        if (i < j) {
            int mid = i + (j - i) / 2;
            mergeSort9(arr, i, mid);
            mergeSort9(arr, mid + 1, j);
            merge9(arr, i, j, mid);
        }
    }

    private static void merge9(int[] arr, int i, int j, int mid) {
        int[] tmp = new int[j - i + 1];
        int p = i;
        int q = mid + 1;
        int k = 0;
    ...
    public static void main(String[] args) {
        ...
        mergeSort9(arr3, 0, arr3.length - 1);
